 ...
 */
class LandActivityOld : AppCompatActivity() {

    private val logTag = LandActivityOld::class.simpleName
...
//            jobService.e(logTag, "   check - 3", "DEBUGGER")
    ...
    private suspend fun migrate(context: Context) {
        ...
        jobDao.getLiveById(migrationJob.jobId).observe(this@LandActivityOld) {
            it?.let {
    ...
    private suspend fun afterMigration(offlineRootsNb: Int) {
        ...
        val res = this@LandActivityOld.resources
