...
package com.pydio.android.cells.transfer.internal;
...
public class UrlHttpClient implements HttpClient {
     ...
     */
    public UrlHttpClient(ClientConfiguration config, ServerURL serverUrl) {
        this.config = config;
    ...
    public HttpResponse execute(final HttpRequest request) throws IOException {
        ...
        final HttpURLConnection connection = serverUrl.withPath(url.getPath()).openConnection();
